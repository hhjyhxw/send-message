...
public class Contants { 
	...
	public static final String smsCode = "%s为您的实名绑定验证码，请于2分钟内填写。如非本人操作，请忽略本短信。";
	public static final String responseSmsTemplate = "您于%s在闪采小程序发布的%s类需求已被%sSKU经理响应，快去看看他提供的好货吧！";
